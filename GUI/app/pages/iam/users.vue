...
async function loadUsers() {
  ...
  try {
    ...
    loadError.value = iamApi.readErrorMessage(err, 'Failed to load users')
  }
  finally {
    loading.value = false
  }
...
async function createUser() {
  ...
  try {
    ...
    loadError.value = iamApi.readErrorMessage(err, 'Failed to create user')
  }
  finally {
    saving.value = false
  }
...
async function updateUser() {
  ...
  try {
    ...
    loadError.value = iamApi.readErrorMessage(err, 'Failed to update user')
  }
  finally {
    saving.value = false
  }
...
async function removeUser(user: UserRecord) {
  ...
  try {
    ...
    loadError.value = iamApi.readErrorMessage(err, 'Failed to delete user')
  }
  finally {
    saving.value = false
  }
