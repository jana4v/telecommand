...
def minify_all_files_in_directory(src_directory, dest_directory):
    for root, dirs, files in os.walk(src_directory):
        ...
        for file in files:
            ...
            if file.endswith(".bat") or file.endswith(".pyc"):
                pass
            else:
...
def generate_dist_files(relative_directory):
    src_directory = os.path.join(src_dir, relative_directory)  # Source directory containing the files
    ...
    if is_legacy_software:
        dist_directory_path = code_dir+os.sep+"deployment"+os.sep+"lib"+os.sep+"legacy"
    else:
        dist_directory_path = code_dir+os.sep+"deployment"+os.sep+"lib"
