...
from Telecommand.src.Models import TcDetailsTblRow,TcRequest, TestProcedure
from Telecommand.src.GenerateProcedure.plugins.BaseClass import ProcedureBase
from Telecommand.src.Logging.Logger import logger
...
if getattr(sys, 'frozen', False):
    ...
    root_package = "Telecommand.src.GenerateProcedure.plugins"
